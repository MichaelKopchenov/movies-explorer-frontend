...
export default function Header({ name, loggedIn }) {
  ...
  return (
    <header className={`header__main ${name !== 'home' ? 'header__main_type_transparent' : ''}`}>
      <div>
        <Link to={'/'} className="header__navigation-home"></Link>
      </div>
      {name === 'home' && !loggedIn ?
        <nav>
            ...
            <ul className='header__navigation-list header__navigation-list_type_ul'>
              ...
              <li className='header__nav-list_type_ul'>
                <Link
                  ...
                  onClick={clickLink}
                >Аккаунт <div className='header__account-icon'></div></Link>
              </li>
            </ul>
            <button type='button' className='header__menu-close' onClick={handelClick}></button>
          </nav>
          <button type='button' className='header__menu' onClick={handelClick}></button>
        </>
      }
    </header>
  )
